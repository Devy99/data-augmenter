...
class NeuralQuestionParaphraser(Transformation):
    """
    ...
    Code reference: https://github.com/GEM-benchmark/NL-Augmenter/tree/main/nlaugmenter/transformations/neural_question_paraphraser
    """
    ...
    def __init__(self, seed=0, max_outputs=-1):
        ...
        self.max_output = max_outputs
        
        model = cache_helper.get_file("ramsrigouthamg-t5_paraphraser-model")
        if model is None:
